...
int main()
{
    ifstream in1("RightPart.txt");
    ifstream in2("LeftPart.txt");
    string line;
    string str1 = "", str2 = "";
    ...
    // cout << str2 << endl;
    partial.push_back(str1);
    partial.push_back(str2);
    string final = join(partial);
    ofstream out ("LeftPart.txt");
